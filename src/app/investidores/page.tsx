...
export default function Investidores() {
  ...
  const filtered = filter === "all" ? EQUIPAMENTOS : EQUIPAMENTOS.filter(e => e.category === filter)
  ...
  return (
    <>
      ...
      <main>
        <section
          className="relative min-h-[520px] bg-[#111] text-white overflow-hidden isolate"
          id="inicio"
        >
        ...
        <section className="wrap py-[83px] md:py-[120px]" id="catalogo">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-5 md:gap-[30px]">
            <div>
              <p className="text-[11px] font-extrabold uppercase tracking-[.14em] text-orange-500 mb-[26px]">
                CATÁLOGO
              </p>
              <h2>
                Monte a sua
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {filtered.map(equip => (
              <article
                key={equip.id}
                className="group flex flex-col overflow-hidden bg-white border border-line transition-all duration-250 hover:shadow-form hover:-translate-y-1"
              >
        ...
        <section className="bg-[#0d0d0e] text-white py-[80px] md:py-[110px]" id="contato">
          <div className="wrap">
            ...
            <p className="max-w-[440px] text-[16px] leading-[1.65] text-[#c4c4c4] mt-6 mb-12">
              Fale direto com nossa equipe pelo WhatsApp ou telefone. Enviamos fotos, medidas e
              condições de cada equipamento.
            </p>
              ...
              <div>
                ...
                <div className="flex gap-5">
                  <a
                    ...
                    className="w-12 h-12 rounded-full bg-orange-500 flex items-center justify-center text-white hover:bg-orange-400 hover:-translate-y-0.5 transition-all"
                  >
              ...
              <div>
                ...
                <div className="flex flex-col gap-3">
                  <a
                    ...
                    className="text-orange-400 hover:text-orange-300 text-[15px] font-semibold no-underline inline-flex items-center gap-2 transition-colors"
                  >
              ...
              <div>
                ...
                <div className="flex flex-col gap-3">
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="text-orange-400 hover:text-orange-300 text-[15px] font-semibold no-underline transition-colors"
                  >
                    VIP Antônio Bezerra
                  </a>
                  <a
