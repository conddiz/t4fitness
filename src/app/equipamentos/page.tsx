  ...
  return (
    <>
      ...
      <header className="header" id="header">
        <a className="brand" href="/" aria-label="T4 Fitness - início">
        ...
        <a className="btn btn-small btn-orange" href="#contato">
          Solicitar Orçamento <span>↗</span>
        </a>
      </header>

      <main>
        <section className="hero-equip" id="inicio">
          <div className="hero-visual-equip">
            <div className="hero-overlay-equip"></div>
          </div>
        ...
        <section className="equip-section wrap" id="equipamentos">
          <div className="section-heading">
            ...
            <p>Desde cardio até musculação, temos tudo que você precisa.</p>
          </div>
          ...
          <div className="equip-grid">
            {filtered.map((equip) => (
              <article key={equip.id} className="equip-card">
        ...
        <section className="equip-cta wrap" id="contato">
          <div className="cta-content">
            ...
            <div className="vip-groups">
              <p className="vip-title">Grupos VIP:</p>
