...
export default function Home() {
  ...
  return (
    <>
      ...
      <header
        className={`edge-pad h-[72px] md:h-[84px] flex items-center gap-6 md:gap-[42px] absolute z-50 w-full top-0 md:top-[34px] border-b border-white/[.13] ${menuOpen ? "bg-ink" : "bg-black"}`}
      >
        <a className="shrink-0" href="#inicio" aria-label="T4 Fitness - início">
          <img
            src="/logo-horizontal.jpeg"
            alt="T4 Fitness"
            className="w-[135px] md:w-[160px] block"
          />
        </a>

        <nav
          className="hidden md:flex items-center gap-[26px] ml-auto"
        ...
        >
          {navLinks.map(link => (
            <a
              key={link.href}
              href={link.href}
              className="text-white no-underline font-semibold text-[16px] hover:text-orange-500 transition-colors"
            >
              {link.label}
            </a>
          ))}
        ...
        <nav
          className={`${menuOpen ? "flex" : "hidden"} absolute top-[71px] left-0 z-50 w-full bg-ink px-[19px] pt-[22px] pb-[25px] flex-col gap-[19px] md:hidden`}
        ...
        >
          {navLinks.map(link => (
            <a
              ...
              className="text-white no-underline font-semibold text-[16px]"
            >
              {link.label}
            </a>
          ))}
      ...
      <main>
        <section
          className="relative flex flex-col min-h-[100svh] md:min-h-[630px] md:block md:h-[min(780px,calc(100vh-34px))] bg-[#111] text-white overflow-hidden isolate"
          id="inicio"
        >
          <div className="absolute inset-0">
            <img
              ...
              alt=""
              aria-hidden="true"
              className="md:hidden w-full h-full object-cover object-center saturate-[.95] contrast-[1.02]"
            />
            <img
              src="/hero.jpg"
              alt="Fachada da T4 Fitness com letreiro 24h"
              className="hidden md:block w-full h-full object-cover object-[center_45%] saturate-[.95] contrast-[1.02]"
            />
          ...
          <div className="wrap relative z-[2] pt-[130px] md:pt-[208px] grow md:grow-0">
            <div className="md:max-w-[640px] md:ml-auto">
              ...
              <p className="w-[min(440px,100%)] text-[16px] leading-[1.65] text-[#ececec] my-[25px]">
                Treine onde o seu ritmo acontece. Estrutura completa, modalidades para todos os
                estilos e uma comunidade que puxa você pra cima.
              </p>
              <div className="flex flex-col md:flex-row items-start md:items-center gap-[18px] md:gap-[30px]">
                <a href="#unidades" className="btn btn-orange">
                  ...
                  <FontAwesomeIcon icon={faArrowRight} className="text-[14px] rotate-45" />
                </a>
                <a href="#experiencia" className="text-link">
                  Conheça a T4{" "}
                  <FontAwesomeIcon
                    icon={faArrowRight}
                    className="text-[15px] ml-1 text-orange-500"
                  />
                </a>
              </div>
            </div>
          ...
          <div className="wrap relative z-[2] mt-10 flex justify-between gap-2.5 text-white pointer-events-none md:absolute md:w-auto md:mx-0 md:mt-0 md:left-[max(24px,calc((100%-1160px)/2))] md:bottom-[70px] md:justify-start md:gap-[30px]">
            ...
            <div className="border-l border-orange-500 pl-[13px] flex flex-col">
              ...
              <span className="text-3xs uppercase tracking-[.08em] mt-[7px]">
                ofertas exclusivas
              </span>
            </div>
          </div>
          ...
          <a
            href="#unidades"
            className="wrap relative z-[2] mt-8 mb-6 flex items-center gap-2.5 text-white text-3xs uppercase tracking-[.13em] no-underline hover:text-orange-500 transition-colors md:absolute md:w-auto md:mx-0 md:my-0 md:bottom-5 md:right-[max(24px,calc((100%-1160px)/2))]"
          >
          ...
          <div className="grid grid-cols-1 md:grid-cols-[1.2fr_.8fr] gap-[27px] md:gap-[70px] items-end">
            ...
            <div>
              <p className="text-[16px] leading-[1.75] text-ink max-w-[360px] mt-[5px] mb-6">
                Na T4, você encontra mais do que equipamentos. Encontra espaço para ganhar força, se
                divertir, dançar, lutar e cuidar de você.
              </p>
              <a
                href="#modalidades"
                className="text-link text-link-dark inline-flex items-center gap-1 mt-2"
              >
                Veja as modalidades{" "}
                <FontAwesomeIcon icon={faArrowRight} className="text-[15px] text-orange-500" />
              </a>
            </div>
          </div>
        ...
        <section className="h-[400px] md:h-[500px] relative overflow-hidden bg-[#14111b]">
          <img
            ...
            className="w-full h-full object-cover object-[center_44%] opacity-[.78]"
          />
          ...
          <div className="absolute inset-0 z-[1] flex flex-col justify-center pl-[19px] md:pl-[max(24px,calc((100vw-1160px)/2))] font-display uppercase">
            <span className="text-[clamp(28px,3.4vw,47px)] font-bold tracking-[.04em] text-white">
              VAI NO
            </span>
            <strong className="text-[clamp(58px,8vw,110px)] leading-[.78] text-orange-500 font-black">
              SEU RITMO
            </strong>
            <span className="text-[clamp(28px,3.4vw,47px)] font-bold tracking-[.04em] text-white">
              VAI MAIS LONGE
        ...
        <section className="bg-[#0d0d0e] text-white py-[82px] md:py-[126px]" id="unidades">
          <div className="wrap">
            <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-5 md:gap-[30px]">
              <div>
                <p className="text-[12px] font-extrabold uppercase tracking-[.14em] text-orange-300 mb-[26px]">
                  SUA T4 MAIS PRÓXIMA
                </p>
                <h2>
                  Escolha onde
            ...
            <div className="mt-[42px] md:mt-[64px] mb-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              ...
              <span
                className="text-[12px] uppercase tracking-[.12em] text-[#a5a5a6]"
                aria-live="polite"
              >
                {unitCount === 0
        ...
        <section className="wrap py-[83px] md:py-[130px]" id="modalidades">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-5 md:gap-[30px]">
            <div>
              <p className="text-[12px] font-extrabold uppercase tracking-[.14em] text-orange-500 mb-[26px]">
                TODA ENERGIA CONTA
              </p>
              <h2>
                Encontre o seu
          ...
          <ul className="mt-[65px] grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 border-t border-l border-line list-none m-0 p-0">
              ...
              >
                <div className="flex items-start justify-between">
                  <img
                    ...
                    alt=""
                    aria-hidden="true"
                    className="h-8 w-auto group-hover:brightness-0 transition-[filter] duration-250"
                  />
                  <span className="font-sans text-[12px] font-bold text-orange-500 group-hover:text-[#111] transition-colors">
                    {mod.number}
                  </span>
                </div>
            ...
            <li className="border-r border-b border-line p-6 md:p-7 min-h-[160px] flex flex-col gap-5 bg-[#0d0d0e] text-white">
              <span className="font-display font-bold uppercase leading-none text-[26px] md:text-[30px] flex items-baseline gap-2">
                Vem pra{" "}
                <img src="/icons/t4.png" alt="T4" className="h-[0.8em] w-auto self-center" />
                <em className="not-italic text-orange-500 -ml-2">.</em>
              </span>
              <a
                href="#contato"
                className="mt-auto text-2xs font-extrabold uppercase tracking-[.09em] text-white no-underline inline-flex items-center gap-[5px] hover:text-orange-500 transition-colors"
              >
                Matricule-se{" "}
                <FontAwesomeIcon
                  icon={faArrowRight}
                  className="text-[13px] text-orange-500 -rotate-45"
                />
              </a>
            </li>
          </ul>
        ...
        <section className="bg-orange-500 py-[80px] md:py-[110px]" id="convenios">
          <div className="wrap grid grid-cols-1 md:grid-cols-2 gap-[45px] md:gap-[70px] items-center">
            <div>
              <p className="text-[12px] font-extrabold uppercase tracking-[.14em] text-white mb-[18px]">
              ...
              <p className="max-w-[375px] text-[16px] leading-[1.65] my-7 text-[#1a1a1c]">
                A T4 aceita os principais benefícios corporativos para tornar o seu treino ainda
                mais acessível.
              </p>
            ...
            <div className="relative overflow-hidden">
              <img
                src="/wellhub-totalpass.webp"
                alt="Wellhub e TotalPass aceitos na T4 Fitness"
                className="w-full h-auto block"
              />
              <div className="absolute inset-0 bg-black/25"></div>
              <div className="absolute inset-0 flex items-center justify-center">
                <span className="text-white text-[14px] md:text-[17px] font-extrabold uppercase tracking-[.2em]">
                  ACEITAMOS
                </span>
              </div>
            </div>
        ...
        <section className="bg-cream py-[80px] md:py-[125px]" id="contato">
          <div className="wrap grid grid-cols-1 md:grid-cols-2 gap-[42px] md:gap-[100px] items-start">
            <div>
              <p className="text-[12px] font-extrabold uppercase tracking-[.14em] text-orange-500 mb-[18px]">
                PRIMEIRO PASSO
              </p>
              <h2 className="flex items-center gap-4 flex-wrap">
                Vem pra <img src="/icons/t4.png" alt="T4" className="h-[0.75em] w-auto" />
                <em className="-ml-4">.</em>
              </h2>
              <p className="max-w-[400px] leading-[1.7] text-[16px] text-ink mt-6">
                Entre no Grupo VIP e fique por dentro das ofertas de inauguração, condições
                especiais e novidades da sua unidade.
              </p>
              <div className="mt-8 flex flex-col gap-2">
                <a
                  href="https://chat.whatsapp.com/JQaxKZssrRm3oUhNLvBogj"
                  target="_blank"
                  rel="noreferrer"
                  className="text-orange-600 hover:text-orange-500 transition-colors font-semibold text-[15px] no-underline inline-flex items-center gap-2"
                >
                  <FontAwesomeIcon icon={faWhatsapp} className="text-[18px]" /> Grupo VIP Antônio
                  Bezerra
                </a>
                <a
                  href="https://chat.whatsapp.com/J1kUHS184lcCOCH33YoHdA"
                  target="_blank"
                  rel="noreferrer"
                  className="text-orange-600 hover:text-orange-500 transition-colors font-semibold text-[15px] no-underline inline-flex items-center gap-2"
                >
                ...
                <a
                  href="tel:+5585987453332"
                  className="text-orange-600 hover:text-orange-500 transition-colors font-semibold text-[15px] no-underline inline-flex items-center gap-2 mt-1"
                >
                  (85) 98745-3332
                </a>
              </div>
            ...
            <form
              ...
              onSubmit={e => {
                ...
                window.open(
                  `https://wa.me/5585987453332?text=${encodeURIComponent(text)}`,
                  "_blank",
                  "noopener,noreferrer"
                )
              }}
      ...
      <footer className="bg-black text-white pt-[55px] pb-5">
        <div className="wrap grid grid-cols-1 md:grid-cols-3 items-center gap-[23px] md:gap-5">
          ...
          <div className="flex items-center gap-5 md:justify-self-end">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              aria-label="Instagram da T4 Fitness"
              className="text-orange-500 hover:text-orange-400 hover:-translate-y-0.5 transition-all"
            >
              <FontAwesomeIcon icon={faInstagram} className="text-[22px]" />
            </a>
            <a
              href="https://www.facebook.com/arenafits/"
              target="_blank"
              rel="noreferrer"
              aria-label="Facebook da T4 Fitness"
              className="text-orange-500 hover:text-orange-400 hover:-translate-y-0.5 transition-all"
            >
              <FontAwesomeIcon icon={faFacebook} className="text-[22px]" />
            </a>
            <a
              href="https://api.whatsapp.com/message/7DVJU2H7CTALF1"
              target="_blank"
              rel="noreferrer"
              aria-label="WhatsApp da T4 Fitness"
              className="text-orange-500 hover:text-orange-400 hover:-translate-y-0.5 transition-all"
            >
        ...
        <div className="wrap mt-[50px] pt-[18px] border-t border-[#2c2c2e] flex flex-col md:flex-row md:justify-between gap-[14px] md:gap-0 text-3xs uppercase tracking-[.06em]">
          ...
          <a
            href="#inicio"
            className="text-white no-underline order-first md:order-none inline-flex items-center gap-1 hover:text-orange-500 transition-colors"
          >
